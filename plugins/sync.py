...
class Sync(dotbot.Plugin):
    ...
    def _process_records(self, records):
        ...
        with open(os.devnull, 'w') as devnull:
            for destination, source in records.items():
                ...
                success &= self._sync(path, destination, dmode, fmode, uid, gid, rsync, options, stdout, stderr)
        if success:
    ...
    def _sync(self, source, destination, dmode, fmode, uid, gid, rsync, options, stdout, stderr):
        '''
